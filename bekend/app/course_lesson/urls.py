from .views import (RederectLessonCourse, GetTopicsCourse, Lesson,
                    OpenQuestionCheck, QuestionTaskCheck, ProgramTaskCheck)
...
urlpatterns = [
    ...
    path('course/<slug:slug>/topic/<slug:slugTopic>/lesson/<slug:slugLesson>/programtask/check', ProgramTaskCheck.as_view())
]