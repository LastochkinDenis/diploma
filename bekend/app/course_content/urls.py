from .views import (CreateTopicApi, GetTopicApi,
                     ...
                     GetLessonEdit, OpenQuestionEdit, QuestionTaskEdit,
                     ProgramTaskEdit)
...
urlpatterns = [
    ...
    path('<slug:slug>/questiontask/<slug:slugTopic>/edit/<slug:slugLesson>', QuestionTaskEdit.as_view()),
    path('<slug:slug>/programtask/<slug:slugTopic>/edit/<slug:slugLesson>', ProgramTaskEdit.as_view())
]