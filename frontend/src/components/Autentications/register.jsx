...
export default class Register extends Component {
    ...
    render() {
        if (this.state.isCrate)
            return <Navigate to="/login" />
        return (
            <div className="authentivations__wraper">
                <h1>Регистрация</h1>
                <hr/>
                <form onSubmit={this.handleFormSubmit} className="authentivations__form">
                    ...
                    <div className="authentivations__form-item">
                        <label>
                            <p>Имя:</p>
                            <input type="text" placeholder="Имя" onChange={this.handleFirstNameChange}/>
                        </label>
                        { this.state.errorFirstName && <p className='error-mesage'>{this.state.errorFirstName}</p>}
                    </div>
                    <div className="authentivations__form-item">
                        <label>
                            <p>Фамилия:</p>
                            <input type="text" placeholder="Фамилия" onChange={this.handleLastNameChange}/>
                        </label>
                        {this.state.errorLastName && <p className='error-mesage'>{this.state.errorLastName}</p>}
                    </div>
                    <div className="authentivations__form-item">
                        <label>
                            <p>Пароль:</p>
