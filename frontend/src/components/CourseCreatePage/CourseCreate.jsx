            ...
            <div className='form__wraper'>
                ...
                <form onSubmit={this.handleFormSubmit}>
                    <div className='form-item'>
                        <label>
                            <p>Название курса:</p>
                            <input onChange={this.handeleNameChange} type='text' placeholder='Название курса'/>
                        </label>
                        {this.state.errorName && <p className='error-mesage'>{this.state.errorName}</p>}
                    </div>
                    <div className='form-item'>
                        <label>
                            <p>Описание курса:</p>
                            <textarea onChange={this.handeleDescriptionChange} placeholder='Описание курса' rows={6}/>
                        </label>
                        {this.state.errorDescripton && <p className='error-mesage'>{this.state.errorDescripton}</p>}
                    </div>
                    <input type='submit' content='Создать курс' className='submitButton'/>
                </form>
            </div>
        )
    }
